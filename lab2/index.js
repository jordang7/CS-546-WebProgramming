...
try {
  // Should Pass
  const meanOne = arrayUtils.mean([100]); // should output 25.8
  console.log(meanOne);
...
try {
  //Should Fail
  const medianS = arrayUtils.medianSquared([]); //should fail
  console.log(medianS);
...
try {
  //Should Pass
  const maxElem = arrayUtils.maxElement([3, 3, 3, 3, 3, 3, 3, 3, 3]); // should return {392.1:3}
  console.log(maxElem);
...
try {
  //Should Fail
  const maxElem = arrayUtils.maxElement([]);
  console.log(maxElem);
...
console.log("---------------------MashUp---------------------------");
try {
  const mash = stringUtils.mashUp("woah", "hello");
  console.log(mash);
...
try {
  ...
  const ide = objUtils.isDeepEqual(fifth, forth);
  console.log(ide);
...
try {
  const ide = objUtils.isDeepEqual("123", "123");
  console.log(ide);
  console.error("isDeepEqual failed test case");
} catch (e) {
...
try {
  const ide = objUtils.isDeepEqual("obj", "obj");
  console.log(ide);
  console.error("isDeepEqual failed test case");
} catch (e) {
  console.error("isDeepEqual errored successfully");
